...
class Logger:
    def __init__(self):
        self.filename = f'./outputs/optuna_training_rf_{datetime.datetime.now().isoformat()}.csv'
...
for i, param_pair in enumerate(param_pairs):
    ...
    proposed_filename = f'output_rf_{param_pair}_{datetime.datetime.now().isoformat()}'
